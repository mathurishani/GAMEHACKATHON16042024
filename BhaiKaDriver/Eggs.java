...
public class Eggs extends JPanel implements Runnable {
    ...
    // Existing code...
        ...
        try {
            backgroundImage = ImageIO.read(getClass().getResource("/farm.jpg"));
...
public void paint(Graphics g2) {
    ...
    GradientPaint gp = new GradientPaint(getWidth() / 2, getHeight(), Color.BLACK, getWidth() / 2, getHeight() - 40, Color.DARK_GRAY);
